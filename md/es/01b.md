...
En el caso de **Windows** o **Linux**, podemos descargar el instalador de la web oficial e instalarlo siguiendo los pasos del asistente.
...
Por ejemplo, podemos crear un acceso directo en el escritorio con el editor *nano* (suponiendo la carpeta */home/alumno/Escritorio/* o */home/alumno/Desktop/*, como la que tenemos en la máquina virtual):

```
nano /home/alumno/Desktop/XAMPP.desktop
```
