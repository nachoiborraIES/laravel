...
En el documento de *[Instalación](instalacion)* se tienen los pasos necesarios para instalar el software requerido. Para cumplir con los requisitos 2, 3 y 4 utilizaremos un sistema XAMPP. Además, en ese documento se ofrecen enlaces para descargar máquinas virtuales con las que trabajar sobre Laravel.
